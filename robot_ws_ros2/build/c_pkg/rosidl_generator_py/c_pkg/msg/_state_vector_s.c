...
bool c_pkg__msg__state_vector__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("c_pkg.msg._state_vector.StateVector", full_classname_dest, 35) == 0);
  }
  c_pkg__msg__StateVector * ros_message = _ros_message;
  {  // vx
...
{
  /* NOTE(esteve): Call constructor of StateVector */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("c_pkg.msg._state_vector");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StateVector");
