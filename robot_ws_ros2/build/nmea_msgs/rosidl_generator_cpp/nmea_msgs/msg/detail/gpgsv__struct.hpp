...
struct Gpgsv_
{
  ...
  using _satellites_type =
    std::vector<nmea_msgs::msg::GpgsvSatellite_<ContainerAllocator>, typename ContainerAllocator::template rebind<nmea_msgs::msg::GpgsvSatellite_<ContainerAllocator>>::other>;
  ...
  Type & set__satellites(
    const std::vector<nmea_msgs::msg::GpgsvSatellite_<ContainerAllocator>, typename ContainerAllocator::template rebind<nmea_msgs::msg::GpgsvSatellite_<ContainerAllocator>>::other> & _arg)
  {
