...
void Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_init_function(
...
void Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_fini_function(void * message_memory)
{
  nmea_msgs__msg__Gpvtg__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_member_array[11] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_members = {
  "nmea_msgs__msg",  // message namespace
  "Gpvtg",  // message name
  11,  // number of fields
  sizeof(nmea_msgs__msg__Gpvtg),
  Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_member_array,  // message members
  Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_init_function,  // function to initialize message memory (memory has to be allocated)
  Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_type_support_handle = {
  0,
  &Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nmea_msgs, msg, Gpvtg)() {
  Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_type_support_handle.typesupport_identifier) {
    Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Gpvtg__rosidl_typesupport_introspection_c__Gpvtg_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
