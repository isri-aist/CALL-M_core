...
def generate_launch_description():
    ...
    cmd = ['ros2', 'launch']
    suffix = ['use_sim_time:=true'] #subscribe to /clock for syncing with client nodes, seems to not be useful, ekf is using odom from camera even if it is put to false, and odom timestamp of camera are the same whatever
