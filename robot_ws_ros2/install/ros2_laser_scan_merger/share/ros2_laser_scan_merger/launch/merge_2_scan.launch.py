...
def generate_launch_description():
    ...
    pointCloudTopic = LaunchConfiguration('pointCloudTopic', default="merger/custom_cloud")
    pointCloutFrameId = LaunchConfiguration('pointCloutFrameId', default="lidar1_link")
    
    #parameter for the first laserscan, feel free to duplicate and rename for other laserscans
    scanTopic1 = LaunchConfiguration('scanTopic1', default="lidar1/scan")
    ...
    scanTopic2 = LaunchConfiguration('scanTopic2', default="lidar2/scan")
