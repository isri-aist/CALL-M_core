...
def run_launch_with_parameters(context):
    ...
    master_with_arm_launch = launch.actions.ExecuteProcess(cmd=cmd + ['call_m_supervisor', 'master_w_arm.launch.py'] + suffix, output='screen')
    ...
    if(version == "NUC" and mode=="ARM"):
        print("\nCALL_M robot with UR5e initialized")
        return [hardware_launch,master_with_arm_launch]
