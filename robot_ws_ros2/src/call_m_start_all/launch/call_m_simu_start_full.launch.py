...
def generate_launch_description():
    ...
    #ros2 launch call_m_nav2 navigation_launch.py params_file:=/home/jrlintern/Desktop/work/CNRS_AIST_Work_All/CNRS_AIST_Mobile_Shopping_Robot/robot_ws_ros2/src/call_m_nav2/config/nav2_params_omni_simu.yaml map_subscribe_transient_local:=true use_sim_time:=true
