...
def generate_launch_description():
    ...
    nav_tree = os.path.join(dir_nav2, 'behavior_trees', 'navigate_w_replanning_and_recovery.xml') #behavior tree to use for navigation #navigate_w_replanning_and_recovery.xml 
