...
int angle_to_index(double alpha, int resolution){
    ...
    // Calculate the index
    return static_cast<int>((alpha * resolution) / (2 * M_PI));
}
...
sensor_msgs::msg::LaserScan filter_data(sensor_msgs::msg::LaserScan::SharedPtr msg,double start_angle, double end_angle){
    ...
    //RCLCPP_INFO(this->get_logger(), "Config angles: '%f' '%f'",start_angle,end_angle);
    //RCLCPP_INFO(this->get_logger(), "Corresponding index: '%d' '%d'",start_index,end_index);
...
private:
    void scan1Callback(const sensor_msgs::msg::LaserScan::SharedPtr msg) {
        ...
        if (frames_got){
            ...
            sensor_msgs::msg::LaserScan tempo = filter_data(msg,lidar1_start_angle, lidar1_end_angle);
            sensor_msgs::msg::LaserScan tempo2 = transform_data(std::make_shared<sensor_msgs::msg::LaserScan>(tempo),vector_newframe_lid1.x,vector_newframe_lid1.y);
            scan1_data_ = std::make_shared<sensor_msgs::msg::LaserScan>(tempo2);
    ...
    void scan2Callback(const sensor_msgs::msg::LaserScan::SharedPtr msg) {
        ...
        if (frames_got){
            ...
            //transform data and configure new message
            sensor_msgs::msg::LaserScan tempo = filter_data(msg,lidar2_start_angle, lidar2_end_angle);
            sensor_msgs::msg::LaserScan tempo2 = transform_data(std::make_shared<sensor_msgs::msg::LaserScan>(tempo),vector_newframe_lid2.x,vector_newframe_lid2.y);
            scan2_data_ = std::make_shared<sensor_msgs::msg::LaserScan>(tempo2);
    ...
    sensor_msgs::msg::LaserScan fuseScans(const sensor_msgs::msg::LaserScan::SharedPtr scan1,const sensor_msgs::msg::LaserScan::SharedPtr scan2) {
        ...
        sensor_msgs::msg::LaserScan fused_data = *scan1; // Assuming headers are the same, the scan1 have already been transform in the new_frame
    ...
    void initialize_params(){
        ...
        this->declare_parameter("lidar2_start_angle"); 
    ...
    void refresh_params(){
        this->get_parameter_or<double>("lidar1_start_angle", lidar1_start_angle, 0.0);
        this->get_parameter_or<double>("lidar1_end_angle", lidar1_end_angle, 2*M_PI);
        this->get_parameter_or<double>("lidar2_start_angle", lidar2_start_angle, 0.0);
        this->get_parameter_or<double>("lidar2_end_angle", lidar2_end_angle, 2*M_PI);
